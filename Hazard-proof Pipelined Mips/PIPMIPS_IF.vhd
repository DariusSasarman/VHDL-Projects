...
architecture Behavioral of PIPMIPS_IF is
...
signal rom : rom_type :=(
    ...
    -- Forwarding of R[3]
    3 => b"000_011_010_100_0_001", -- R[4] <= R[3] - R[2]   instr== x"0C41" // R[4] <= 9
    ...
    -- Stall 1 Cycle because of Load Word and usage of loaded Word R[1] in 12
    12=> b"101_001_001_0000001"  , -- If(R[1]==R[1]) goto 14 instr=x"A481"
    13=> b"000_001_001_001_0_000", -- R[1] <= R[1] + R[1] instr == x"0490" 
    14=> b"110_010_001_0000001"  , -- If(R[2] < R[1]) goto 16 instr=x"C881"
    15=> b"000_010_010_001_0_000", -- R[1] <= R[2] + R[2] instr == x"0910" 
    16=> b"010_001_001_0001001"  , -- R[1] <= R[1] + 9      instr== x"4489" // R[1] <= 18
    others => x"E000"              -- Others <= Jump 0
);
